CREATE TABLE msproduct.discount(
discount_id int NOT NULL,
discount_percent int NOT NULL,
PRIMARY KEY (discount_id)
);

CREATE TABLE msproduct.products(
...
FOREIGN KEY (discount_id) REFERENCES msproduct.discount(discount_id)
);

INSERT INTO msproduct.discount(discount_id,discount_percent)
VALUES(100,0),
(102,2),
(105,5);

INSERT INTO msproduct.products(product_id,product_name,product_category,product_description,product_price,discount_id,product_available)
